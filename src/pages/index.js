    ...
    return (
      ...
      <IndexWrapper>
        <h1 className="headline">
          Or Fleisher is an award-winning creative technologist, developer and
          artist working at the intersection of technology and storytelling.
        </h1>
        ...
        <Section title="Recent work">
          <Grid container>
            {posts.map(({ node: post }) => {
              ...
              return (
                <Grid key={post.frontmatter.path} item xs={6} sm={6} md={4} xl={3}>
                  <GridUnit
                    key={post.frontmatter.path}
                    alt_text={post.frontmatter.path}
                    projectImage={require('../assets/images/gifs' +
                      frontmatter.path +
                      '.gif')}
                    colour="#BDBDBD"
        ...
        <ScrollableAnchor id={'contact'}>
          <Section title="">
            <p>
              Email me at{' '}
              <span className="bold">contact(at)orfleisher.com</span>
            </p>
            <div className="row">
              <a
                rel="noopener"
                target="_blank"
                href="http://github.com/juniorxsound"
              >
                <img
                  alt="Github"
              ...
              <a
                rel="noopener"
                target="_blank"
                href="http://twitter.com/juniorxsound"
              >
                <img
                  alt="Twitter"
              ...
              <a
                rel="noopener"
                target="_blank"
                href="http://facebook.com/or.fleisher"
              >
                <img
                  alt="Facebook"
              ...
              <a
                rel="noopener"
                target="_blank"
                href="http://linkedin.com/in/orfleisher/"
              >
                <img
                  alt="Linkedin"
              ...
              <a
                rel="noopener"
                target="_blank"
                href="https://www.youtube.com/channel/UCLCfTDhutnzsBoxeSlUls9A"
              >
                <img
                  alt="YouTube"
              ...
              <a
                rel="noopener"
                target="_blank"
                href="http://vimeo.com/orfleisher"
              >
                <img
                  alt="Vimeo"
              ...
              <a
                rel="noopener"
                target="_blank"
                href="http://instagram.com/juniorxsound/"
              >
                <img
                  alt="Instagram"
