import thumbnailImage from '@/public/images/thumbnails/climbing.jpg'
import coverImage from '@/public/images/headers/ondra.jpg'
...
export const metadata = {
  ...
  animatedThumbnail: '/images/gifs/adam-ondra-climbing.gif',
  cover: coverImage,
  heroVideoSources: [
    { src: '/videos/hero/adam_ondra.webm', type: 'video/webm' },
    { src: '/videos/hero/adam_ondra_h264.mp4', type: 'video/mp4' },
  ],
  embed: '',
  about:
  ...
  links: [
    [
      'nytimes.com',
      'https://www.nytimes.com/interactive/2021/sports/olympics/adam-ondra-climbing.html?unlocked_article_code=1.s1A.za7v.vSPSukNiDeKB&smid=url-share',
    ],
  ],
  excerpt:
