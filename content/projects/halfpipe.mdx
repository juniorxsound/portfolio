import thumbnailImage from '@/public/images/thumbnails/winteroly.png'

import coverImage from '@/public/images/headers/halfpipe_header.jpg'
...
export const metadata = {
  ...
  animatedThumbnail: '/images/gifs/oly-eileen-gu-halfpipe-ski.gif',
  cover: coverImage,
  heroVideoSources: [
    { src: '/videos/hero/halfpipe.webm', type: 'video/webm' },
    { src: '/videos/hero/halfpipe_h264.mp4', type: 'video/mp4' },
  ],
  embed: '',
  about:
  ...
  links: [
    [
      'nytimes.com',
      'https://www.nytimes.com/interactive/2022/02/17/sports/olympics/eileen-gu-halfpipe-ski.html?unlocked_article_code=1.s1A.Cjuz.7hQiOJYd9PDE&smid=url-share',
    ],
  ],
