import thumbnailImage from '@/public/images/thumbnails/olytracking.png'
...
export const metadata = {
  ...
  animatedThumbnail: '/images/gifs/oly-tracking.gif',
  cover: coverImage,
  embed: '',
  about:
  ...
  links: [
    [
      'nytimes.com',
      'https://www.nytimes.com/interactive/2021/07/31/sports/olympics/thompson-herah-track-100m-won-olympics.html?unlocked_article_code=1.s1A.wjrd.kKJkeMyugOrr&smid=url-share',
    ],
    [
      'R&D Blog',
