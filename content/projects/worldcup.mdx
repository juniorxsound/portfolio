import coverImage from '@/public/images/headers/world-cup.jpg'
import thumbnailImage from '@/public/images/thumbnails/worldcup.png'
export const metadata = {
  ...
  animatedThumbnail: '/images/gifs/world-cup.gif',
  cover: coverImage,
  heroVideoSources: [
    { src: '/videos/hero/world_cup.webm', type: 'video/webm' },
    { src: '/videos/hero/world_cup_h264.mp4', type: 'video/mp4' },
  ],
  embed: '',
  about:
  ...
  links: [
    [
      'nytimes.com',
      'https://www.nytimes.com/interactive/2022/12/03/sports/world-cup/richarlison-messi-pulisic-world-cup-goals.html?unlocked_article_code=1.s1A.0VEa.GnD79-4A3hvV&smid=url-share',
    ],
    [
      'R&D Blog',
