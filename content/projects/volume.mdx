import coverImage from '@/public/images/headers/volume_cover.jpg'
import thumbnailImage from '@/public/images/thumbnails/volume.png'
...
export const metadata = {
  ...
  animatedThumbnail: '/images/gifs/volume.gif',
  cover: coverImage,
  heroVideoSources: [
    { src: '/videos/hero/volume.webm', type: 'video/webm' },
    { src: '/videos/hero/volume_h264.mp4', type: 'video/mp4' },
  ],
  embed: '',
  about:
