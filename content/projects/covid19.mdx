...
import thumbnailImage from '@/public/images/thumbnails/covid19.png'
...
export const metadata = {
  ...
  animatedThumbnail:
    '/images/gifs/coronavirus-transmission-cough-6-feet-ar.gif',
  cover: coverImage,
  heroVideoSources: [
    { src: '/videos/hero/covid19.webm', type: 'video/webm' },
    { src: '/videos/hero/covid19_h264.mp4', type: 'video/mp4' },
  ],
  embed: '',
  about:
  ...
  links: [
    [
      'nytimes.com',
      'https://www.nytimes.com/interactive/2020/04/14/science/coronavirus-transmission-cough-6-feet-ar-ul.html?unlocked_article_code=1.s1A.uncT.DC48kyMgpZ7c&smid=url-share',
    ],
  ],
