import thumbnailImage from '@/public/images/thumbnails/esb.png'

import coverImage from '@/public/images/headers/esb_header.jpg'
...
export const metadata = {
  ...
  animatedThumbnail:
    '/images/gifs/empire-state-building-reopening-new-york.gif',
  cover: coverImage,
  embed: '',
  about:
  ...
  links: [
    [
      'nytimes.com',
      'https://www.nytimes.com/interactive/2021/09/15/nyregion/empire-state-building-reopening-new-york.html?unlocked_article_code=1.s1A.lzap.k-FMymAc4itg&smid=url-share',
    ],
    [
      'Print',
