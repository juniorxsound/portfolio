import thumbnailImage from '@/public/images/thumbnails/of1.png'
import coverImage from '@/public/images/headers/our_force_1_header.jpg'
import montageImage from '@/public/images/montage_of1.png'
...
export const metadata = {
  ...
  animatedThumbnail: '/images/gifs/our-force-1.gif',
  cover: coverImage,
  heroVideoSources: [
    { src: '/videos/hero/tlp.webm', type: 'video/webm' },
    { src: '/videos/hero/tlp_h264.mp4', type: 'video/mp4' },
  ],
  links: [
    [
      'Nike Blog',
...
<OptimizedImage src={montageImage} alt="Our Force 1 collection" />
